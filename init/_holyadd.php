...
$id[] = "INSERT INTO holyday VALUES (10, 1, 0, 0, 11, 1, 1, NULL, NULL, NULL, NULL, 9, 1, NULL, NULL, NULL);";
// Maha Shiva ratri
...
$name[] = "INSERT INTO holyname VALUES (9, 2, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'Пауш Нава Ратри', 'FF0000', NULL, 'Это один из скрытых (Гупта) Наваратри. Празднуется в первый день светлой части (шукла пакша) месяца Пауш.', 'В переводе с санскрита слово «наваратри» означает «девять ночей». В ходе этого праздника, продолжающегося десять дней и девять ночей, индуисты поклоняются девяти ипостасям Шакти/Деви — женской форме Бога. Кульминация фестиваля приходится на десятый его день, называемый Виджая-дашами.', 'http://ru.wikipedia.org/wiki/Наваратри', 'Наваратри', 'http://nathi.ru/read/articles/Navaratri', 'Наваратри', NULL, NULL);";
$name[] = "INSERT INTO holyname VALUES (9, 1, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'Paush Nava Ratri', 'FF0000', NULL, 'Paush Navaratri is nine days dedicated to the nine forms of Shakti (Mother Goddess) in the month of Paush (December–January). Paush Navaratri is observed during the Paush Shukla Paksha (waxing phase of moon).', 'Navratri is a festival dedicated to the worship of the Hindu deity Durga. The word Navaratri literally means nine nights in Sanskrit, nava meaning nine and ratri meaning nights. During these nine nights and ten days, nine forms of Shakti/Devi are worshiped.', 'http://en.wikipedia.org/wiki/Navaratri', 'Navaratri', NULL, NULL, NULL, NULL);";
